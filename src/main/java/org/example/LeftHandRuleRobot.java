...
public class LeftHandRuleRobot implements Robot {
    ...
    /**
     * Description: Moves the LeftHandRobot to the left position and changes the direction.
     * @param left - The position to the left.
     */
    public void moveToLeft(Position left){
        direction = direction.turnLeft();
        setPosition(left);
    }

    /**
     * Description: Moves the LeftHandRobot to the right position and changes the direction.
     * @param right - The position to the right.
     */
